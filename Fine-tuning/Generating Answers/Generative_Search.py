...
def search_andrews_article(query):
    ...
    query_embed = co.embed([query]).embeddings
...
# def search_andrews_article(query):
#     # Get the query's embedding
#     query_embed = co.embed(tests=[query]).embeddings
...
#     search_results = tests[similar_item_ids[0]]
...
# 
# To start building with the Cohere LLMs, get 
# your API key by registering 
# [here](https://dashboard.cohere.ai/welcome/
# register?utm_source=
# partner&utm_medium=website&utm_campaign=
# DeeplearningAI). 
# 
# Learn more about LLMs at Cohere’s 
# [LLM.University](https://LLM.University).